        ...
        <>
            <div className='  my-16 md:my-28 container flex flex-col md:flex-row max-w-screen-2xl mx-auto md:px-20 px-4'>
                <div className='md:w-1/2 w-full space-y-6 order-2 md:order-1'>
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolore, exercitationem ipsum! Iusto a similique nostrum cumque dolorum nesciunt ducimus quam sit porro molestias modi, facilis alias voluptate quod, illo officia.</p>
                ...
                <div className='md:w-1/2 w-full order-1'>
                    <img src={banner} alt="" className='w-3/4 mx-auto my-6 md:my-2 md:px-2' />
                </div>
            </div>
        </>
    )
